...
const baseSchema = {
  ...
  hwid_limit: z.coerce.number().min(0).optional().default(0),
                ...
                <GridItem>
                  <VStack justifyContent="space-between">
                    ...
                    >
                      ...
                      <FormControl mb={"10px"}>
                        <FormLabel>HWID Limit (0 = Unlimited)</FormLabel>
                        <Controller
                          control={form.control}
                          name="hwid_limit"
                          render={({ field }) => {
                            return (
                              <Input
                                ...
                                onChange={field.onChange}
                                disabled={disabled}
                                error={form.formState.errors.hwid_limit?.message}
