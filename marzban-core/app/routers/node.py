...
def add_node(
    ...
    if getattr(new_node, 'ssh_host', None):
        from app.utils.deploy import deploy_node_via_ssh
        bg.add_task(deploy_node_via_ssh, dbnode.id, new_node.ssh_host, new_node.ssh_port, new_node.ssh_username, new_node.ssh_password, new_node.ssh_key)
